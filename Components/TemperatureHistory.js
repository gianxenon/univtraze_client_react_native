...
const TemperatureHistory = ({ navigation, route: {params: {id, type}}}) => {
	...
	const handleGetUserTemperature = async (token, id) => {
		...
		await axios.post(`https://univtraze.herokuapp.com/api/rooms/userTodaysTemperature`, data, config)
		.then((response) => {
	...
	const handleGetAllUserTemperatureHistory = async (token, id) => {
		...
		await axios.post(`https://univtraze.herokuapp.com/api/rooms/userTemperatureHistory`, data, config)
		.then((response) => {
