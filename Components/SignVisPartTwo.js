			...
			<View style={{ height: "100%" }}>
				...
				>
					<KeyboardAvoidingView style={{ height: "100%" }}>
						...
						>
							<Text style={styles.label}>Valid I.D No.{studentNumber}</Text>
							<TextInput
								placeholder="Valid I.D No."
								defaultValue={""}
								onChangeText={(text) => {
						...
						>
							<Text style={{ marginVertical: 15 }}>School I.D</Text>
							<View
								style={{
									flexDirection: "row",
									alignItems: "center",
